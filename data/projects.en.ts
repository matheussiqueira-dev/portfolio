...
export const projectsEn: Project[] = [
  ...
  },
  {
    ...
    tagline: "Fiscal dashboards and indicators for a commercial unit.",
    role: "Data Analyst",
    ...
    problem: [
      ...
      "No consolidated view of revenue performance.",
    ],
    dataUsed: [
      "Municipal revenue bases and public fiscal data.",
    ...
    features: [
      "Indicators by period, municipality, and segment.",
      "Visual alerts for variations and anomalies.",
      "Dynamic filters with comparative views.",
    ],
    highlights: [
      "Consolidated view for managers and revenue teams.",
      "Fast detection of fiscal anomalies and trends.",
      "Consistent base for strategic decision-making.",
    ],
    demonstrates: [
      "End-to-end BI with public and fiscal data.",
      "Delivery of actionable indicators for leaders.",
      "Focus on data quality and governance.",
    ],
    howToRun: [
      "Prerequisites: Power BI Desktop and data source access.",
      "Connect fiscal sources and run the ETL flow.",
