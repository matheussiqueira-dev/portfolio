...
const projectList: ProjectCase[] = [
  {
    ...
    demo: {
      ...
      caption: "Efeito de invisibilidade em tempo real com calibraÃ§Ã£o visual.",
    },
    intro: {
      title: "Capa da Invisibilidade â€” Efeito em tempo real no navegador",
      paragraphs: [
        "Projeto full stack que aplica um efeito de invisibilidade em tempo real no navegador, com controles de calibraÃ§Ã£o e mascaramento.",
        "O processamento acontece localmente via Canvas para reduzir latÃªncia e preservar privacidade, com backend opcional para snapshots e mÃ©tricas.",
      ],
      sections: [
        {
          title: "Diferenciais",
          items: [
            "Processamento local de vÃ­deo para privacidade e baixa latÃªncia.",
            "Controles visuais para calibraÃ§Ã£o precisa do efeito.",
            "Backend modular e opcional para registrar resultados.",
            "Setup simples para demonstraÃ§Ãµes e estudos.",
          ],
        },
        {
          title: "Arquitetura",
          items: [
            "Frontend com loop de vÃ­deo no Canvas e estado em React.",
            "Backend com API REST em Fastify, validaÃ§Ã£o e seguranÃ§a.",
            "PersistÃªncia em arquivo JSON para facilitar o setup local.",
          ],
        },
        {
    ...
    context:
      "A meta era criar um efeito de invisibilidade em tempo real que rodasse no navegador, com baixa latÃªncia, calibraÃ§Ã£o visual e backend opcional para registrar resultados.",
    problem: [
      "Mascarar cores de forma estÃ¡vel sob diferentes iluminaÃ§Ãµes.",
      "Manter performance no processamento de vÃ­deo em tempo real.",
      "Oferecer controles visuais para calibrar o efeito.",
      "Registrar snapshots e mÃ©tricas sem complicar o setup.",
    ],
    dataUsed: [
      "Frames da webcam processados localmente.",
      "MÃ¡scaras de cor e parÃ¢metros de segmentaÃ§Ã£o.",
      "Snapshots e mÃ©tricas de desempenho (opcional).",
      "ConfiguraÃ§Ãµes de calibraÃ§Ã£o do efeito.",
    ],
    solution: [
      "Pipeline de processamento no Canvas com mascaramento ajustÃ¡vel.",
      "UI com controles de calibraÃ§Ã£o de cor e intensidade.",
      "API REST opcional em Fastify com validaÃ§Ã£o Zod e API key.",
      "PersistÃªncia simples em arquivo JSON para facilitar o setup.",
    ],
    features: [
      "Efeito de invisibilidade em tempo real no navegador.",
      "Controles visuais para ajuste fino do mascaramento.",
      "Backend opcional para snapshots e mÃ©tricas.",
    ...
    highlights: [
      ...
      "Boas prÃ¡ticas com validaÃ§Ã£o, CORS e rate limiting.",
    ],
    demonstrates: [
      "VisÃ£o computacional no navegador com Canvas API.",
      "IntegraÃ§Ã£o full stack com API REST.",
      "ValidaÃ§Ã£o e seguranÃ§a com Zod e API key.",
      "Arquitetura modular com frontend e backend opcionais.",
    ],
    techSummary:
      "React + TypeScript + Canvas API no frontend e Fastify + Zod no backend opcional para snapshots e mÃ©tricas.",
    conclusion: [
      "Entreguei um efeito de invisibilidade performÃ¡tico e calibrÃ¡vel.",
      "Garanti privacidade com processamento local e backend opcional.",
      "Deixei uma base pronta para evoluÃ§Ã£o com mÃ©tricas e integraÃ§Ãµes.",
    ],
    howToRun: [
    ...
    screenshots: [
      ...
      {
        src: "/Capa da Invisibilidade.mp4",
        alt: "DemonstraÃ§Ã£o em vÃ­deo da Capa da Invisibilidade",
        type: "video",
      },
      {
    ...
    seo: {
      ...
      description:
        "Projeto full stack de efeito de invisibilidade em tempo real com Canvas no frontend e backend opcional em Fastify para snapshots e mÃ©tricas.",
    },
  },
  {
    ...
    demo: {
      ...
      poster: "/Thmbnail/Thumbnail - Portugues/Simulador de DecisÃ£o Empresarial.png",
    ...
    screenshots: [
      {
        src: "/Thmbnail/Thumbnail - Portugues/Simulador de DecisÃ£o Empresarial.png",
  ...
  },
  {
    ...
    demo: {
      ...
      poster: "/Thmbnail/Thumbnail - Portugues/DetecÃ§Ã£o de Anomalias Operacionais.png",
    ...
    screenshots: [
      {
        src: "/Thmbnail/Thumbnail - Portugues/DetecÃ§Ã£o de Anomalias Operacionais.png",
  ...
  },
  {
    ...
    screenshots: [
      {
        src: "/Thmbnail/Thumbnail - Portugues/API de Biblioteca AvanÃ§ada.png",
  ...
  },
  {
    ...
    headline: "Synthwave Space | Shooter espacial 2D com estÃ©tica synthwave",
    tagline:
      "Jogo 2D em JavaScript puro com visual retrÃ´-futurista, controles por teclado/toque e progressÃ£o dinÃ¢mica.",
    role: "Desenvolvedor",
    ...
    demo: {
      ...
      caption: "Gameplay com ondas progressivas, efeitos visuais e ambientaÃ§Ã£o neon.",
    },
    context:
      "Projeto criado para praticar arquitetura de jogo 2D em JavaScript puro, com foco em performance, feedback visual e experiÃªncia mobile/desktop.",
    problem: [
      "Construir um game loop estÃ¡vel sem frameworks.",
      "Manter jogabilidade fluida em diferentes tamanhos de tela.",
      "Criar progressÃ£o de dificuldade sem perder legibilidade.",
      "Implementar efeitos visuais e sonoros mantendo boa performance.",
    ],
    dataUsed: [
      "Entrada de teclado e toque para movimentaÃ§Ã£o e aÃ§Ãµes.",
      "Estado do jogo: energia, escudo, pontuaÃ§Ã£o e multiplicador.",
      "Temporizadores para spawn de inimigos, power-ups e eventos.",
      "Objetos em cena (nave, inimigos, projÃ©teis, partÃ­culas e HUD).",
    ],
    solution: [
      "RenderizaÃ§Ã£o com HTML5 Canvas e loop contÃ­nuo baseado em delta time.",
      "Entidades separadas (nave, inimigos, tiros, power-ups) para facilitar evoluÃ§Ã£o.",
      "Dificuldade adaptativa com escalonamento de ondas e hazards.",
      "Camada audiovisual com efeitos synthwave e trilha dinÃ¢mica via Web Audio API.",
    ],
    features: [
      "Controle por teclado no desktop e toque no mobile.",
      "Sistema de energia, escudo, combates com boss e multiplicador de score.",
      "Power-ups, efeitos de partÃ­culas, shake de cÃ¢mera e feedback visual.",
      "PersistÃªncia de recordes para acompanhar progressÃ£o.",
    ],
    highlights: [
      "Visual retrÃ´-futurista consistente com identidade synthwave.",
      "ExperiÃªncia adaptada para desktop e mobile.",
      "Loop de jogo leve e responsivo com JavaScript puro.",
      "Base pronta para novas fases, inimigos e mecÃ¢nicas.",
    ],
    demonstrates: [
      "Game loop, colisÃ£o e gerenciamento de estado em Canvas.",
      "Design de gameplay com progressÃ£o e balanceamento.",
      "IntegraÃ§Ã£o de Ã¡udio e efeitos visuais para feedback do jogador.",
      "Arquitetura front-end modular sem dependÃªncias pesadas.",
    ],
    techSummary:
      "Jogo 2D em JavaScript + HTML5 Canvas com HUD em tempo real, dificuldade progressiva e ambientaÃ§Ã£o synthwave com Ã¡udio e partÃ­culas.",
    conclusion: [
      "Consolidei fundamentos de desenvolvimento de jogos em JavaScript puro.",
      "Entreguei uma experiÃªncia consistente entre desktop e mobile.",
      "Deixei uma base extensÃ­vel para novos modos e conteÃºdos.",
    ],
    howToRun: [
      "Clone o repositÃ³rio.",
      "Abra o arquivo index.html no navegador.",
    ...
    screenshots: [
      ...
      },
      {
        ...
        alt: "DemonstraÃ§Ã£o em GIF do Synthwave Space",
        type: "gif",
      },
      {
        src: "/projects/synthwave-space/demo.mp4",
    ...
    seo: {
      ...
      description:
        "Jogo 2D com estÃ©tica synthwave construÃ­do em JavaScript puro e HTML5 Canvas, com ondas progressivas, power-ups, bosses e suporte mobile.",
    },
  },
  {
    slug: "slingshot",
  ...
  },
  {
    ...
    demo: {
      ...
      poster: "/Thmbnail/Thumbnail - Portugues/Reconhecimento de Gestos de MÃ£o em Tempo Real.png",
    ...
    screenshots: [
      {
        src: "/Thmbnail/Thumbnail - Portugues/Reconhecimento de Gestos de MÃ£o em Tempo Real.png",
  ...
  {
    slug: "eye-tracking",
    title: "Eye Tracking em Tempo Real",
    headline: "Eye Tracking | Rastreamento ocular via webcam comum",
    tagline:
      "Sistema de eye tracking em tempo real com webcam comum, calibracao de 9 pontos, filtros de baixa latencia e heatmap dinamico.",
    role: "Desenvolvedor/Arquiteto",
    stack: ["Python", "OpenCV", "MediaPipe", "NumPy", "Computer Vision"],
    repoUrl: "https://github.com/matheussiqueira-dev/Eye-Tracking.git",
    intro: {
      title: "Eye Tracking em tempo real para analise comportamental",
      paragraphs: [
        "Projeto de visao computacional que transforma uma webcam comum em um sistema de rastreamento ocular em tempo real.",
        "A arquitetura inclui calibracao supervisionada de 9 pontos, estimativa de gaze com compensacao de pose de cabeca e heatmap dinamico de atencao.",
      ],
      sections: [
        {
          title: "Arquitetura",
          items: [
            "Captura assincrona da camera para reduzir latencia.",
            "Deteccao de face/landmarks com MediaPipe e modelagem vetorial da iris.",
            "Estimativa de gaze com fusao binocular e fallback por pose de cabeca.",
            "Estabilizacao temporal (One Euro + Kalman) e rejeicao de outliers.",
          ],
        },
        {
          title: "Entrega de dados",
          items: [
            "Heatmap dinamico de atencao em tempo real.",
            "Exportacao de eventos em NDJSON para analytics e BI.",
            "Atalhos para calibracao, reset, captura de screenshot e debug.",
          ],
        },
      ],
    },
    context:
      "A proposta foi democratizar o uso de Eye Tracking sem hardware proprietario, mantendo alta performance e estrutura pronta para evolucao em produto.",
    problem: [
      "Rastrear direcao do olhar com webcam comum em tempo real.",
      "Reduzir jitter e instabilidade em variacoes de pose e iluminacao.",
      "Permitir calibracao simples e repetivel para melhorar precisao.",
      "Gerar dados estruturados de atencao para analise posterior.",
    ],
    dataUsed: [
      "Frames de webcam em alta taxa de captura.",
      "Landmarks faciais e da iris via MediaPipe.",
      "Vetor de gaze com confianca por olho e fusao binocular.",
      "Eventos de gaze e coordenadas para heatmap/exportacao em NDJSON.",
    ],
    solution: [
      "Pipeline modular Camera -> Landmarks -> Gaze -> Stabilization -> Heatmap -> Event Log.",
      "Calibracao supervisionada de 9 pontos com regressao linear regularizada.",
      "Compensacao de pose de cabeca e fallback em oclusoes parciais.",
      "Filtros temporais e controle de outliers para reduzir ruido visual.",
    ],
    features: [
      "Eye tracking em tempo real com webcam comum.",
      "Calibracao de 9 pontos com reset rapido em runtime.",
      "Heatmap dinamico de atencao visual.",
      "Exportacao de eventos para analytics em NDJSON.",
      "Controles de debug, screenshot e tuning de performance.",
    ],
    highlights: [
      "Arquitetura extensivel orientada a produto.",
      "Baixa latencia com captura assincrona e filtros temporais.",
      "Fusao binocular com peso por confianca para maior robustez.",
      "Integracao simples com pipelines de dados e BI.",
    ],
    demonstrates: [
      "Visao computacional aplicada a UX e comportamento.",
      "Estimativa de gaze com MediaPipe e OpenCV.",
      "Engenharia de dados para logging estruturado de eventos.",
      "Design de pipeline em tempo real com foco em performance.",
    ],
    techSummary:
      "Python com OpenCV, MediaPipe e NumPy para eye tracking em tempo real, calibracao supervisionada, estabilizacao temporal e heatmap com exportacao de eventos.",
    conclusion: [
      "Entreguei um prototipo completo de eye tracking sem hardware dedicado.",
      "A base esta pronta para evoluir para dashboards, observabilidade e streaming de eventos.",
      "O projeto demonstra uniao de visao computacional, engenharia de dados e produto.",
    ],
    howToRun: [
      "Requisitos: Python 3.10 a 3.12 e webcam funcional.",
      "Crie o ambiente: python -m venv .venv e ative o ambiente virtual.",
      "Instale dependencias: pip install -r requirements.txt.",
      "Execute: python run.py --camera-id 0 --width 1280 --height 720 --target-fps 120.",
      "Use C para calibrar, H para heatmap, D para debug, R para reset e Q/ESC para sair.",
    ],
    screenshots: [
      {
        src: "/projects/eye-tracking/cover.png",
        alt: "Capa principal do projeto Eye Tracking em Tempo Real",
      },
      {
    ...
    seo: {
      title: "Eye Tracking em Tempo Real | Webcam + OpenCV + MediaPipe",
      description:
        "Sistema de eye tracking em tempo real com webcam comum, calibracao de 9 pontos, filtros de baixa latencia, heatmap e exportacao de eventos para analytics.",
    },
  },
];
