...
export const projects: Project[] = [
  ...
  },
  {
    ...
    problem: [
      "Dados fiscais dispersos em multiplas fontes.",
      "Relatorios manuais atrasavam decisoes comerciais.",
      "Falta de visao consolidada de arrecadacao.",
    ],
    dataUsed: [
    ...
    solution: [
      ...
      "Modelo de dados orientado a indicadores fiscais.",
      "Dashboards estrategicos com visao executiva.",
    ],
    features: [
      "Indicadores por periodo, municipio e segmento.",
      "Alertas visuais para variacoes e anomalias.",
      "Painel com filtros dinamicos e visao comparativa.",
    ],
    highlights: [
      "Visao consolidada para gestores e equipe de arrecadacao.",
      "Deteccao rapida de anomalias e tendencias fiscais.",
      "Base consistente para decisao estrategica.",
    ],
    demonstrates: [
      "BI end-to-end com dados publicos e fiscais.",
      "Entrega de indicadores acionaveis para gestores.",
      "Foco em qualidade e governanca de dados.",
    ],
    howToRun: [
      "Pre-requisitos: Power BI Desktop e acesso as fontes.",
      "Conecte as fontes fiscais e execute o ETL.",
