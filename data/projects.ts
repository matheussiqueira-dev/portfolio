...
const projectList: ProjectCase[] = [
  ...
  },
  {
    ...
    tagline:
      "Sistema de eye tracking em tempo real com webcam comum, calibração de 9 pontos, filtros de baixa latência e heatmap dinâmico.",
    role: "Desenvolvedor/Arquiteto",
    ...
    intro: {
      ...
      paragraphs: [
        "Projeto de visão computacional que transforma uma webcam comum em um sistema de rastreamento ocular em tempo real.",
        "A arquitetura inclui calibração supervisionada de 9 pontos, estimativa de gaze com compensação de pose de cabeça e heatmap dinâmico de atenção.",
      ],
      sections: [
        {
          title: "Arquitetura",
          items: [
            "Captura assíncrona da câmera para reduzir latência.",
            "Detecção de face/landmarks com MediaPipe e modelagem vetorial da íris.",
            "Estimativa de gaze com fusão binocular e fallback por pose de cabeça.",
            "Estabilização temporal (One Euro + Kalman) e rejeição de outliers.",
          ],
        },
        {
          title: "Entrega de dados",
          items: [
            "Heatmap dinâmico de atenção em tempo real.",
            "Exportação de eventos em NDJSON para analytics e BI.",
            "Atalhos para calibração, reset, captura de screenshot e debug.",
          ],
        },
      ],
    },
    context:
      "A proposta foi democratizar o uso de Eye Tracking sem hardware proprietário, mantendo alta performance e estrutura pronta para evolução em produto.",
    problem: [
      "Rastrear direção do olhar com webcam comum em tempo real.",
      "Reduzir jitter e instabilidade em variações de pose e iluminação.",
      "Permitir calibração simples e repetível para melhorar precisão.",
      "Gerar dados estruturados de atenção para análise posterior.",
    ],
    dataUsed: [
      "Frames de webcam em alta taxa de captura.",
      "Landmarks faciais e da íris via MediaPipe.",
      "Vetor de gaze com confiança por olho e fusão binocular.",
      "Eventos de gaze e coordenadas para heatmap/exportação em NDJSON.",
    ],
    solution: [
      "Pipeline modular Camera -> Landmarks -> Gaze -> Stabilization -> Heatmap -> Event Log.",
      "Calibração supervisionada de 9 pontos com regressão linear regularizada.",
      "Compensação de pose de cabeça e fallback em oclusões parciais.",
      "Filtros temporais e controle de outliers para reduzir ruído visual.",
    ],
    features: [
      "Eye tracking em tempo real com webcam comum.",
      "Calibração de 9 pontos com reset rápido em runtime.",
      "Heatmap dinâmico de atenção visual.",
      "Exportação de eventos para analytics em NDJSON.",
      "Controles de debug, screenshot e tuning de performance.",
    ],
    highlights: [
      "Arquitetura extensível orientada a produto.",
      "Baixa latência com captura assíncrona e filtros temporais.",
      "Fusão binocular com peso por confiança para maior robustez.",
      "Integração simples com pipelines de dados e BI.",
    ],
    demonstrates: [
      "Visão computacional aplicada a UX e comportamento.",
    ...
    techSummary:
      "Python com OpenCV, MediaPipe e NumPy para eye tracking em tempo real, calibração supervisionada, estabilização temporal e heatmap com exportação de eventos.",
    conclusion: [
      "Entreguei um protótipo completo de eye tracking sem hardware dedicado.",
      "A base está pronta para evoluir para dashboards, observabilidade e streaming de eventos.",
      "O projeto demonstra união de visão computacional, engenharia de dados e produto.",
    ],
    howToRun: [
    ...
    seo: {
      ...
      description:
        "Sistema de eye tracking em tempo real com webcam comum, calibração de 9 pontos, filtros de baixa latência, heatmap e exportação de eventos para analytics.",
    },
  },
];
